...
import 'package:snapstar_app/app/data/providers/story_provider.dart';
...
class AppBindings extends Bindings {
  ...
  void dependencies() {
    ...
    Get.put<PostRepository>(PostRepository(Get.find<PostProvider>(), Get.find<PostService>()), permanent: true,);
    ...
    Get.put(GlobalMediaController(), permanent: true);
  }
}